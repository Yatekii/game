...
pub fn startup(
    ...
    let texture_handle: Handle<Image> = asset_server.load("tile_jungle_ground_brown.png");

    let map_size = TilemapSize { x: 6, y: 3 };
    ...
    let tile_size = TilemapTileSize { x: 96.0, y: 64.0 };
